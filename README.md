...
The publication describing this code has just (August 9, 2019) been accepted and will be provided after its official release (we are currently waiting for proofs). If you end up finding this work useful and using the code in your publication, please give us some credit.
